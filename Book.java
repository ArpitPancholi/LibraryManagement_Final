...
public class Book {
    ...
    public Book(String title, String author, int publicationYear, int ISBN, boolean issued, boolean reserved) {
        this(title, author, publicationYear, ISBN);
        this.issued = issued;
        this.reserved = reserved;
    }

    public Book(String title, String author, int publicationYear, int ISBN, boolean issued) {
        this(title, author, publicationYear, ISBN);
        this.issued = issued;
    }
}